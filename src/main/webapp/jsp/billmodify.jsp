...
<!-- 				<input type="hidden" name="method" value="modifysave"> -->
                ...
                <div class="">
                    ...
                    <input type="text" name="billCode" id="billCode" value="${param.billcode }" readonly="readonly"> 
                </div>
                <div>
                    <label for="productName">商品名称：</label>
                    <input type="text" name="productName" id="productName" value="${param.productname }"> 
					<font color="red"></font>
                </div>
                <div>
                    <label for="productUnit">商品单位：</label>
                    <input type="text" name="productUnit" id="productUnit" value="${param.proname }"> 
					<font color="red"></font>
                </div>
                <div>
