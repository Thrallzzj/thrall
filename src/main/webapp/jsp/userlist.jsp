...
<%@include file="/jsp/common/head.jsp"%>
        <div class="right">
			...
			<%-- <input type="hidden" id="totalPageCount" value="${totalPageCount}"/> --%>
          	...
          	<a href="pageuser?currentpage=1">首页</a>
          	<a href="pageuser?currentpage=${page.currentpage-1 }">上一页</a>
          	<a href="pageuser?currentpage=${page.currentpage+1 }">下一页</a>
          	<a href="pageuser?currentpage=${page.lastpage }">尾页</a>
        </div>
    </section>
